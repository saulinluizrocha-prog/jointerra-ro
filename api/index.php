      ...
      <div class="container">
        ...
        <div class="form" id="cloneThis">
          <form method="post" class="x_order_form orderForm">
            ...
            <input required type="text" name="name" placeholder="Introduceţi numele dvs." autocomplete="name">
            <input required type="tel" name="phone" class="only_number" placeholder="Introduceți numărul dvs. de telefon" autocomplete="tel" onkeyup="this.value=this.value.replace(/\s/,'')" minlength="5">
            <div class="prices">
              <div class="new">
                <b class="js_new_price x_price_current">119</b> <span class="js_curs x_currency">RON</span>
              </div>
              <div class="old">
                <s class="js_old_price x_price_previous">238</s><span class="js_curs x_currency">RON</span>
              </div>
            </div>
    ...
    <section class="s1 s17">
      <div class="container">
        ...
        <div class="form form-to">
          <form method="post" class="x_order_form orderForm">
            <div class="ti">
              <div class="timer_head"> Până la sfârșitul promoţiei a rămas: </div>
              <div class="timer">
                <div><span class="hours"></span><span class="desc">ore</span></div><span style="font-size: 40px;">:</span>
                <div><span class="minutes"></span><span class="desc">minute</span></div><span style="font-size: 40px;">:</span>
                <div><span class="seconds"></span><span class="desc">secunde</span></div>
              </div>
            </div>
            <p style="text-align: center;font-size: 14px;">Începutul promoției <span class="date-1"></span><br>
              Promoția se termină <span class="date-0"></span></p><br>
